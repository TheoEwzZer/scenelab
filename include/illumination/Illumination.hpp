...
public:
    ...
    void renderRasterUI(App *app, RasterizationRenderer *rasterRenderer);
...
protected:
    const std::array<Material, 8> materials
        = { Material(glm::vec3(0.33, 0.22, 0.03), glm::vec3(0.78, 0.57, 0.11),
                glm::vec3(0.99, 0.94, 0.81), glm::vec3(0, 0, 0), 28.0f, 0.3f,
                1.0f, 1.0f, 0.0f),
              Material(glm::vec3(0.21, 0.13, 0.05),
                  glm::vec3(0.71, 0.43, 0.18), glm::vec3(0.39, 0.27, 0.17),
                  glm::vec3(0, 0, 0), 26.0f, 0.4f, 1.0f, 1.0f, 0.0f),
              Material(glm::vec3(0.25, 0.20, 0.07),
                  glm::vec3(0.75, 0.61, 0.23), glm::vec3(0.63, 0.56, 0.37),
                  glm::vec3(0, 0, 0), 50.0f, 0.1f, 1.0f, 1.0f, 0.0f),
              Material(glm::vec3(0.23, 0.23, 0.23),
                  glm::vec3(0.51, 0.51, 0.51), glm::vec3(0.5, 0.5, 0.5),
                  glm::vec3(0, 0, 0), 51.0f, 0.05f, 1.0f, 1.0f, 0.0f),
              Material(glm::vec3(0.19, 0.07, 0.02),
                  glm::vec3(0.70, 0.27, 0.08), glm::vec3(0.26, 0.14, 0.09),
                  glm::vec3(0, 0, 0), 12.8f, 0.2f, 1.0f, 1.0f, 0.0f),
              Material(glm::vec3(0.2, 0.2, 0.2), glm::vec3(0.5, 0.5, 0.5),
                  glm::vec3(0.0, 0.0, 0.0), glm::vec3(0, 0, 0), 1.0f, 0.5f,
                  0.1f, 1.45f, 0.0f),
              ...
              Material(glm::vec3(0.2, 0.2, 0.2), glm::vec3(0.8, 0.8, 0.8),
                  glm::vec3(0.9, 0.9, 0.9), glm::vec3(0, 0, 0), 45.0f, 0.4f,
                  0.3f, 1.5f, 0.0f) };
