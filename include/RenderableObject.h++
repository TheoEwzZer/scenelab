...
protected:
    ...
    void setUseTexture(const bool useTexture) {m_useTexture = useTexture && m_textureHandle >= 0;}
    ...
    virtual void useShader(ShaderProgram& shader) const {}

    virtual void draw(const ShaderProgram& vectorial, const ShaderProgram& pointLight, const ShaderProgram& lighting, const TextureLibrary& textures) const = 0;
};
